...
namespace NinjaOne.Client.V2.Organization.Item.Template.Item.Document
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::NinjaOne.Client.V2.Organization.Item.Template.Item.Document.DocumentRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::NinjaOne.Client.V2.Organization.Item.Template.Item.Document.DocumentPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::NinjaOne.Client.V2.Organization.Item.Template.Item.Document.DocumentPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::NinjaOne.Client.V2.Organization.Item.Template.Item.Document.DocumentRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
